/**
 * Delete All Articles and News Content
...
async function deleteAllArticles() {
  ...
  console.log('⚠️  WARNING: This will delete ALL articles and related data from the database!\n');
  ...
  try {
    ...
    // Confirm deletion (in production, you might want to add a prompt here)
...
module.exports = deleteAllArticles;
